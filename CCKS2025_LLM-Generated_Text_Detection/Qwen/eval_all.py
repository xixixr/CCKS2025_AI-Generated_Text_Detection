...
model_path = "/data/workspace/xiarui/tianchi_LMTextDetect/CCKS2025_LLM-Generated_Text_Detection/output/Qwen/finetune_all"
model_state = torch.load(os.path.join(model_path, "model.pth"))
